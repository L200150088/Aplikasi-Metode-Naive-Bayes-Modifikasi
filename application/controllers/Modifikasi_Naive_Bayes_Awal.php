...
class Modifikasi_Naive_Bayes_Awal extends CI_Controller
{
    public $CI = NULL;
    ...
    public function index()
    {
        $naive_bayes = $this->Naive_Bayes_model->get_all();
         ...
         $this->breadcrumbs->push('modifikasi_naive_bayes_awal', '/modifikasi_naive_bayes_awal');
 
         $data = array(
          
             'content'     => 'modifikasi_naive_bayes_awal/modifikasi_naive_bayes_list', 
