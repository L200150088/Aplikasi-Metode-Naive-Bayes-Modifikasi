        ...
        <div class="panel-heading">
            ...
            <div class="row">
                <div class="col-md-45 text-left">
                   ...
                   <?php echo anchor(site_url('pengujian/pengujian'), '<i class="fa fa-dashboard fa-1x"></i> Lakukan Pengujian', 'class="btn btn-success" data-popup="tooltip-custom" title="tambah data"'); ?>
                </center></div>
            ...
            <table class="table datatable-responsive table-sm table-striped" id="mytable">
                ...
                
                {
                    ...
                    $hasil = $this->CI->hasil($naive_bayes->id);
            ?>
                    <tr>
                        ...
                        <?php 
                            ...
                            echo anchor(site_url('naive_bayes/algoritma_naive_bayes/'. $naive_bayes->id), '<i class="fa fa-eye fa-1x"></i> Lihat Perhitungan', 'class="btn btn-info" data-popup="tooltip-custom" title="Analisa Prediksi"');
...
$(function() {
    ...
    $.extend( $.fn.dataTable.defaults, {
        ...
        language: {
            ...
            lengthMenu: '<span>Tampilkan Sejumlah:</span> _MENU_',
