...
<div class="content">
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            <h5 class="panel-title"><center><b>Hasil Modifikasi Naive Bayes</center></b></h5>
        ...
        <div class="panel-body"> 
                    ...
                    <table class="table datatable-responsive table-sm table-bordered" id="mytable">
                        ...
                        <tr>
                                <td style="background-color: aqua;">Yes</td>
                                <td><b><h5><center><?= $hasil_modifikasi_yes?></center></b></h5></td>
                                
                            </tr>
                            <tr>
                                <td style="background-color: aqua;">No</td>
                                <td><h5><b><center><?= $hasil_modifikasi_no?></center></h5></td>
