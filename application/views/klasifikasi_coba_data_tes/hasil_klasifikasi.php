...
<div class="content">
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            <h5 class="panel-title"><center><b>Hasil Klasifikasi Naive Bayes<b></center></h5>
        ...
        <center><h4><b>Peluang Probabilitas Variable Y</b></h4></center>
                    ...
                    <center><h4><b>Prediksi Probabilitas Tiap Kelas</b></h4></font></center>
                    <table class="table datatable-responsive table-sm table-bordered" id="mytable">
                        <thead>
                        <tr>
                                <th>Variabel Y</th>
                        ...
                        <tbody>
                            <tr>
                                <td style="background-color: aqua;">Yes</td>
                                <td><b><h5><center><?= $yes?></h5></center></td>
                                
                            </tr>
                            <tr>
                                <td style="background-color: aqua;">No</td>
                                <td><h5><center><?= $no?></h5></center></td>
                                
                            </tr><tr style="background-color: aqua;">
                                <td><b>Prediksi</td>
                                <td><b><center><?= $prediksi; ?></center></td>
