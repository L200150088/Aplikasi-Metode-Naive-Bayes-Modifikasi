    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            ...
            <div class="row">
                ...
                <center><?php echo anchor(site_url('laplace_smoothing/'), '<i class="fa fa-dashboard fa-1x"></i> Prediksi Laplace Smoothing', 'class="btn btn-info" data-popup="tooltip-custom" "'); ?>
                </center>
                </div>
            ...
            <table class="table datatable-responsive table-sm table-striped" id="mytable">
                <thead>
                    <tr>
                        ...
                        <td style="background-color: aqua;">Prediksi Laplace Smoothing</th>
            ...
            ?>
                    <tr>
                        ...
                        <td style="background-color: aqua;"> <h6><b>-</b></h6> </td>
