...
<div class="content">
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            <h5 class="panel-title"><center><b>Laplace Smoothing Di Terapkan Pada Modifikasi Naive Bayes</b></center></h5>
            ...
            <div class="row">
                ...
                <center> <?php echo anchor(site_url('laplace_smooting/'), '<i class="fa fa-dashboard fa-1x"></i> Prediksi Laplace Smoothing', 'class="btn btn-info" data-popup="tooltip-custom" title="tambah data"'); ?>
                    <?php echo anchor(site_url('pengujian/pengujian_laplace'), '<i class="fa fa-dashboard fa-1x"></i> Lakukan Pengujian', 'class="btn btn-success" data-popup="tooltip-custom" title="tambah data"'); ?>
                    </center></div>
            ...
            <table class="table datatable-responsive table-sm table-striped" id="mytable">
                <thead>
                    <tr>
                        ...
                        <th>Previous</th>
                        <th>Variabel Y</th>
                        <th>Prediksi Laplace Smoothing</th>
            ...
            <?php
                ...
                {
                    $hasil = $this->CI->hasil_laplace_smoothing($naive_bayes->id);
            ?>
                    <tr>
                        ...
                        <?php 
                            ...
                            echo anchor(site_url('laplace_smoothing/algoritma_laplace_smoothing/'. $naive_bayes->id), '<i class="fa fa-eye fa-1x"></i> Lihat Perhitungan', 'class="btn btn-info" data-popup="tooltip-custom" title="Analisa Prediksi"');
                        ?>
                        </td>
                        </td>
            <?php
