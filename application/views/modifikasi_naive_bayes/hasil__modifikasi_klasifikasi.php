...
<div class="content">
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            <h5 class="panel-title">Hasil Klasifikasi Modifikasi Naive Bayes</h5>
        ...
        <center><b>Peluang Probabilitas Variable Y</center>
                    ...
                    <table class="table datatable-responsive table-sm table-bordered" id="mytable">
                        ...
                        <tr>
                                <td style="background-color: aqua;">Yes</td>
                                <td><center><?= $hasil_modifikasi_yes?></center></td>
                                
                            </tr>
                            <tr>
                                <td style="background-color: aqua;">No</td>
                                <td><center><?= $hasil_modifikasi_no?></center></td>
